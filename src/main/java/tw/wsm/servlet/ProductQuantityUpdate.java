...
@WebServlet("/productQuantityUpdate/*")
public class ProductQuantityUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String responseText = updateProductQuantity(productQuantity, productId);
	...
	private String updateProductQuantity(int productQuantity, String productId) {
