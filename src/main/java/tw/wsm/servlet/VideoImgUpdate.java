...
@WebServlet("/videoImgUpdate/*")
public class VideoImgUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public VideoImgUpdate() {
		super();
...
//					成功歡迎詞
					...
					updateVideoPic(imgFileName, videoId);
				}
		...
		String responseText = updateVideoPic(imgFileName, videoId);
...
//		request.getRequestDispatcher("/WEB-INF/views/uploadResponse.jsp").forward(request, response);
	...
	private String updateVideoPic(String imgFileName, String videoId) {
