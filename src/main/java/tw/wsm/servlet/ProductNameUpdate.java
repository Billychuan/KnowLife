...
@WebServlet("/productNameUpdate/*")
public class ProductNameUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String responseText = updateVideoName(productName, productId);
	...
	private String updateVideoName(String productName, String productId) {
