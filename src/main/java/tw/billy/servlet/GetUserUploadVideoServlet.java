...
@WebServlet("/GetUserUploadVideoServlet")
public class GetUserUploadVideoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<VideoBean> list = userService.selectUserUploadVideo(userId);
