...
<body>
    ...
    <header>
                                ...
                                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="member_myVideo.jsp">
                                            <img src="images/file-earmark-play.svg" alt="" width="30" height="24" class="d-inline-block align-text-left">
                                            我的影片
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="member_store.jsp">
                                            <img src="images/collection-play.svg" alt="" width="30" height="24" class="d-inline-block align-text-left">
                                            已購買課程
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapse_manage" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="channalInfo.jsp">
                                                <img src="images/bar-chart-line.svg" alt="" width="30" height="24" class="d-inline-block align-text-left">
                                                資訊主頁
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="videoManager.jsp">
                                                <img src="images/film.svg" alt="" width="30" height="24" class="d-inline-block align-text-left">
                                                影片管理
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse_money" aria-expanded="false" aria-controls="flush-collapseThree">
                                    <img src="images/currency-exchange.svg" alt="" width="30" height="24" class="d-inline-block align-text-left">儲值功能
                                </button>
                            </h2>
                            <div id="flush-collapse_money" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="paytoken.jsp">
                                                <img src="images/credit-card.svg" alt="" width="30" height="24" class="d-inline-block align-text-left">
                                                代幣儲值
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="payRecord.jsp">
                                    ...
                                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="QA.jsp">
                                                <img src="images/patch-question.svg" alt="" width="30" height="24" class="d-inline-block align-text-left">
                                                常見問題                                          
                                            </a>
                                        </li>
                                    </ul>
        ...
        <nav class="navbar">
            <a href="testVideoPage.jsp">精選內容</a>
            <a href="testVideoPage.jsp">主題探索</a>
            <a href="VideoCart.jsp">影片購物車</a>
            <a href="QA.jsp">聯絡我們</a>
        </nav>

        <div class="icons">
                <i class="fas fa-search" id="search-btn"></i>
                <a href="MemberPageServlet"><i class="fas fa-user" id="login-btn"></i></a>
                ...
                <form action="http://localhost:8080/KnowLife/getSearchVideoServlet" class="search-bar-container" method="get">
    ...
    <section class="home" id="home">
        ...
        <div class="controls">
            <span class="vid-btn active" data-src="videos/sportvideo1.mp4"></span>
    ...
    <section class="packages" id="packages">
        ...
        <div class="box-container">
            ...
            <div class="box container">
                <img class="img-fluid w-100" src="images/10分.JPG" alt="" style="height: 33vh;">
                <div class="content">
                    <h3>10分鐘數緩瑜珈</h3>
