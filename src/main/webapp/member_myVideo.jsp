			...
			<div class="row">
				<div class="leftPage col-md-2 ">
					<div class="box1">
                            ...
                            <a class="atag" href="memberManager.jsp"><div class="box1">上傳影片</div></a>
                            <a class="atag" href="member_myVideo.jsp"><div class="box1">我的影片</div></a>
                        	...
                        	<a class="atag" href="http://localhost:8080/KnowLife/LogoutServlet"><div class="box1">登出</div></a>
